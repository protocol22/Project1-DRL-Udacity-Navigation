...
The project aim is to train an agent to collect yellow banana in a square environment comprising of violet and yellow bananas.  
...
3. Clone the repository and place the extracted file in the home director of the repository and run the model using the `Navigation.ipynb` file
